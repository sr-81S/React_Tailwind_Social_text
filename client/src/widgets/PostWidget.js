...
const PostWidget = ({name,description}) => {
  return (
    <div className='p-6 bg-blue-50 rounded-xl my-4 drop-shadow-md ' >
        <div className='flex items-center justify-between' >
          <div className='flex items-center justify-between gap-2' >
              <div className='w-[60px] h-[60px] ' >
                <img className=' w[60px] h-[60px] rounded-[50%] ' src={profilePicture} alt="ProfilePicture" />
              </div>
              <div>
          ...
          <i className="fa-solid fa-user-plus text-xl text-[#074FB2] cursor-pointer " ></i>
        </div>
        <div className=' my-3 ' >
